  ...
  <section class="tenant-shell">
      ...
      <table v-if="orderedTenants.length" class="tenant-table">
        ...
        <tbody>
          ...
          >
            ...
            <td>{{ permissionLabel(tenant.permission) }}</td>
    ...
    >
      <div class="ghost-row">
        ...
        <span>{{ permissionLabel(dragPreview.tenant.permission) }}</span>
...
const permissionLabel = (value: TenantInstance['permission']) => (value === 'read_only' ? '只读' : '读写');
